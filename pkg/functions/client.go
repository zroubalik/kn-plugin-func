...
type PipelinesProvider interface {
	...
	ConfigurePAC(context.Context, Function, pipelines.PacMetadata) error
}
...
func (c *Client) ConfigurePAC(ctx context.Context, f Function, metadata pipelines.PacMetadata) error {
	var err error
	go func() {
		<-ctx.Done()
		c.progressListener.Stopping()
...
func (n *noopPipelinesProvider) ConfigurePAC(ctx context.Context, _ Function, _ pipelines.PacMetadata) error {
	return nil
}
